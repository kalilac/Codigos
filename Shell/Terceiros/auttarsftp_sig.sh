...
#dirbase="/var/www/html/sigcatering/auttar" #Diretorio base do programa
dirbase="/webdir/arenaweb/www71/sigcatering/auttar" #Diretorio base do programa
...
clear
curl "http://aquitemingresso.com/bilheteria/auttarcsv.php"
curl "http://aquitemingresso.com/sigcatering/conciliacaofinanceira"
