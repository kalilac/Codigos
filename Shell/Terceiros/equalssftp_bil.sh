...
dirbase="/webdir/arenaweb/www71/bilheteria2b/equals" #Diretorio base do programa
...
clear
curl http://aquitemingresso.com/bilheteria2b/conciliacaofinanceira
echo "envio de $num arquivos para Equals" > $arquivolog
...
echo " " >> $arquivolog
		...
		acesso(){
                expect -c 'spawn sftp -i ~/arenadasdunas.com.br.pem -P 20220 '$usuario'@'$servidor';
                        sleep 1;
                        expect >; send "cd upload/venda-interna-bilheteria/\n" 
                        expect >; send "put *\n";
                        sleep 1;
                        expect >; send "ls -alh\n";
                        sleep 1;
