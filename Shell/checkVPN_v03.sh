...
IPVPNAUTTAR01="10.104.1.222"
PUBLICAUTTAR="201.7.192.198"
...
checkconnection(){
	...
	IDCONNECTION=$($SNMPWALK $IPVPNAUTTAR01 $OIDIP | fgrep "$PUBLICAUTTAR" | cut -f 10 -d "." | cut -f 1 -d "=")
